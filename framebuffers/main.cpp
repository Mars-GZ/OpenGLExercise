...
int main() {
    ...
    Shader screenShader("../screenVertex.glsl", "../screenFrag.glsl");
...
// cube VAO
    ...
    unsigned int cubeTexture = loadImage("../../resource/marble.jpg");
    unsigned int floorTexture = loadImage("../../resource/metal.png");
